...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          '_classifierInput': dict(classifierOnly=True, n=121, fieldname='categoryx', w=21, type='SDRCategoryEncoder', ),
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[0\]:window=1000:field=categoryx")
minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[0\]:window=1000:field=categoryx"
