...
config = {
    ...
    'fieldname': u'categoryx',
    'n': 121,
    'name': '_classifierInput',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'letter':     {   'fieldname': u'letter',
    'n': 121,
    'name': u'letter',
    'type': 'SDRCategoryEncoder',
    'w': 21},
...
control = {
 ...
 u'predictedField': u'categoryx',
 u'predictionSteps': [0]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'categoryx', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [0], 'errorMetric': 'avg_err'})
  ],
